- [ 01设计模式之单例设计模式](#head1)
	...
	- [ 四、单例设计模式分类](#head5)
	- [ 五、单例模式思想的传递过程](#head6)
	- [六、懒加载（Lazy Load）](#head7)
	- [ 七、单例设计模式的线程安全问题](#head8)
	- [ 八、单例模式分类剖析](#head9)
		- [5.1 饿汉式单例模式（推荐）](#head10)
		- [5.2 普通懒汉式单例模式](#head11)
		- [5.3 同步锁懒汉式单例模式](#head12)
		- [5.4 同步代码块懒汉式单例模式](#head13)
		- [5.5 双重校验锁/双检锁单例模式（推荐）](#head14)
		- [5.6 静态内部类/登记式单例模式（推荐）](#head15)
		- [5.7 枚举单例模式](#head16)
	- [ 九、解决多种破坏单例模式原则的方法](#head17)
		- [9.1 反射破坏单例模式原则剖析](#head18)
		- [9.2 序列化破坏单例模式原则剖析](#head19)
	- [ 十、枚举单例模式的关键底层和攻击解决](#head20)
		- [10.1 反射攻击枚举单例模式](#head21)
		- [10.2 序列化攻击枚举单例模式](#head22)
	- [ 十一、表格总结](#head23)
# <span id="head1"> 01设计模式之单例设计模式</span>

------



### <span id="head2"> 一、什么是单例设计模式？</span>
...
### <span id="head3"> 二、单例设计模式的优缺点</span>
...
### <span id="head4"> 三、单例设计模式的使用</span>

> 当想要控制实例数目，节省系统资源的时候。并且在一个全局内，解决内存中频繁创建和销毁实例对象问题。



### <span id="head5"> 四、单例设计模式分类</span>
...
### <span id="head6"> 五、单例模式思想的传递过程</span>
...
### <span id="head7">六、懒加载（Lazy Load）</span>
...
### <span id="head8"> 七、单例设计模式的线程安全问题</span>
...
#### <span id="head18">9.1 反射破坏单例模式原则剖析</span>
...
#### <span id="head19">9.2 序列化破坏单例模式原则剖析</span>
...
### <span id="head20"> 十、枚举单例模式的关键底层和攻击解决</span>

> 关于枚举单例模式的代码，就只是一个`INSTANCE`。但是它怎么实现的，是如何避免反射和序列化攻击的，我们有待研究。



#### <span id="head21">10.1 反射攻击枚举单例模式</span>
...
#### <span id="head22">10.2 序列化攻击枚举单例模式</span>
