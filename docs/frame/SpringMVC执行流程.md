...
|                     doDispatch()方法源码                     |
| :----------------------------------------------------------: |
| ![image-20200719211355102](SpringMVC执行流程.assets/image-20200719211355102.png) |
...
|                        render方法源码                        |
| :----------------------------------------------------------: |
| ![image-20200719213629854](SpringMVC执行流程.assets/image-20200719213629854.png) |
...
|                        view.render()                         |
| :----------------------------------------------------------: |
| ![image-20200719214907676](SpringMVC执行流程.assets/image-20200719214907676.png) |

可见，此View对象并不简单，它执行了一番过后，由于我的网页跳转时使用的请求转发，于是就到了如下页面源码：

|                   InternalResourceView源码                   |
| :----------------------------------------------------------: |
| ![image-20200719215303749](SpringMVC执行流程.assets/image-20200719215303749.png) |
...
| :----------------------------------------------------------: |
| ![image-20200720215021940](SpringMVC执行流程.assets/image-20200720215021940.png) |
