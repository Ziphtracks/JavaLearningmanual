- [ JavaWeb之Servlet基础](#head1)
	- [ 一、初识Servlet](#head2)
		- [1.1 Servlet概念](#head3)
		- [1.2 Servlet的核心作用](#head4)
		- [1.3 Servlet核心目录结构](#head5)
		- [1.3 IDEA工具内创建核心目录结构](#head6)
		- [1.4 Servlet的开发步骤](#head7)
			- [1.4.1 开发步骤](#head8)
			- [1.4.2 web.xml配置文件添加配置信息](#head9)
			- [1.4.3 我们的第一个Servlet（MyServlet代码）](#head10)
			- [1.4.4 解决浏览器输出显示乱码问题](#head11)
			- [1.4.5 解决idea控制台乱码 ](#head12)
		- [1.5 Web中路径问题](#head13)
			- [1.5.1 路径分类](#head14)
			- [1.5.2 路径分析](#head15)
	- [ 二、Servlet的使用](#head16)
		- [2.1 Servlet核心接口和类](#head17)
			- [2.1.1 实现Servlet接口（繁琐）](#head18)
			- [2.1.2 继承GenericServlet 抽象类（无协议）](#head19)
			- [2.1.3 继承HttpServlet抽象类（有协议，推荐使用）](#head20)
		- [2.2 Servlet的两种配置方式](#head21)
			- [2.2.1 web.xml配置方式（支持所有版本）](#head22)
			- [2.2.2 注解类WebServlet配置方式（支持3.0版本以后）](#head23)
			- [2.2.3 IDEA中快捷创建Servlet类并自动添加注解](#head24)
			- [2.2.4 Servlet默认访问欢迎页面配置](#head25)
			- [2.2.5 Servlet访问状态码跳转页面设置](#head26)
		- [2.3 获取请求参数](#head27)
		- [2.4 处理获取请求参数乱码问题](#head28)
			- [2.4.1 表单中产生中文乱码的原因](#head29)
			- [2.4.2 解决接收Get请求参数乱码问题](#head30)
			- [2.4.3 解决接收Post请求参数乱码问题](#head31)
		- [2.5 处理响应后浏览器显示乱码问题](#head32)
			- [2.5.1 响应后浏览器页面显示乱码的原因](#head33)
			- [2.5.2 解决响应后浏览器页面显示乱码问题](#head34)
	- [ 三、Servlet与JDBC集成的综合案例](#head35)
		- [ db.properties配置文件](#head36)
		- [ 数据库](#head37)
		- [ entity实体类](#head38)
		- [ utils工具类](#head39)
		- [ UserDao接口](#head40)
		- [ UserDaoImpl实体类](#head41)
		- [ UserService接口](#head42)
		- [ UserServiceImpl实体类](#head43)
		- [ GetAllUserServlet](#head44)
		- [ InsertUserServlet](#head45)
	- [ 四、页面跳转](#head46)
		- [4.1 重定向](#head47)
			- [4.1.1 重定向实现原理](#head48)
			- [4.1.2 重定向的特点](#head49)
			- [4.1.3 利用重定向实现页面跳转](#head50)
			- [4.1.4 重定向的第二种方式](#head51)
		- [4.2 请求转发](#head52)
			- [4.2.1 请求转发实现原理](#head53)
			- [4.2.2 请求转发的特点](#head54)
			- [4.2.3 利用请求转发实现功能](#head55)
		- [4.3 response对象操作响应行和响应头](#head56)
			- [4.3.1 操作响应行](#head57)
				- [4.3.1.1 操作正常的响应状态码](#head58)
				- [4.3.1.2 操作错误的响应状态码](#head59)
			- [4.3.2 操作响应头](#head60)
				- [4.3.2.1 添加新值](#head61)
				- [4.3.2.2 直接赋值](#head62)
			- [4.4 页面的定时跳转](#head63)
		- [4.5 Request对象操作请求行、请求头和请求参数](#head64)
			- [4.5.1 操作请求行](#head65)
				- [4.5.1.1 获取请求路径](#head66)
				- [4.5.1.2 获取请求方式](#head67)
				- [4.5.1.3 获取请求地址上面的IP地址](#head68)
				- [4.5.1.4 获取请求地址上面的端口号](#head69)
				- [4.5.1.5 获取请求地址后面拼接的内容（GET请求）](#head70)
			- [4.5.2 操作请求头](#head71)
				- [4.5.2.1 获取User-Agent（浏览器类型）](#head72)
			- [4.5.3 操作请求参数【重点】](#head73)
				- [4.5.3.1 获取请求参数](#head74)
				- [4.5.3.2 获取所有请求参数名称](#head75)
				- [4.5.3.3 获取指定参数的所有值](#head76)
				- [4.5.3.4 获取请求参数对应的Map集合](#head77)
	- [ 五、Servlet的生命周期](#head78)
		- [5.1 什么是生命周期？](#head79)
		- [5.2 Servlet生命周期的四个阶段](#head80)
			- [5.2.1 HttpServlet生命周期演示](#head81)
	- [ 六、Sevlet线程安全问题](#head82)
		- [6.1 线程安全问题](#head83)
		- [6.2 如何保证线程安全问题](#head84)
			- [6.2.1 加synchronized同步代码块（锁）](#head85)
			- [6.2.2 实现SingleThreadModle接口](#head86)
			- [6.2.3 使用局部变量](#head87)
	- [ 七、Servlet初始化参数及配置](#head88)
		- [7.1 什么是Servlet初始化参数](#head89)
		- [7.2 了解Servlet初始化参数机制](#head90)
		- [7.3 Servlet初始化参数配置方式](#head91)
			- [7.3.1 xml配置文件配置初始化参数](#head92)
		- [7.3.2 使用注解配置初始化参数](#head93)
# <span id="head1"> JavaWeb之Servlet基础</span>

------



### <span id="head2"> 一、初识Servlet</span>



#### <span id="head3">1.1 Servlet概念</span>
...
#### <span id="head4">1.2 Servlet的核心作用</span>
...
#### <span id="head5">1.3 Servlet核心目录结构</span>
...
#### <span id="head6">1.3 IDEA工具内创建核心目录结构</span>
...
#### <span id="head7">1.4 Servlet的开发步骤</span>



##### <span id="head8">1.4.1 开发步骤</span>
...
##### <span id="head9">1.4.2 web.xml配置文件添加配置信息</span>
...
##### <span id="head10">1.4.3 我们的第一个Servlet（MyServlet代码）</span>
...
##### <span id="head11">1.4.4 解决浏览器输出显示乱码问题</span>
...
##### <span id="head12">1.4.5 解决idea控制台乱码 </span>
...
#### <span id="head13">1.5 Web中路径问题</span>



##### <span id="head14">1.5.1 路径分类</span>

> 关于路径分类有这么几种：**绝对路径**、**相对路径**和**根路径**



##### <span id="head15">1.5.2 路径分析</span>
...
### <span id="head16"> 二、Servlet的使用</span>



#### <span id="head17">2.1 Servlet核心接口和类</span>

> **关于使用Servlet有三种方法：** 实现Servlet接口、继承GenericServlet 抽象类、继承HttpServlet抽象类



##### <span id="head18">2.1.1 实现Servlet接口（繁琐）</span>
...
##### <span id="head19">2.1.2 继承GenericServlet 抽象类（无协议）</span>
...
##### <span id="head20">2.1.3 继承HttpServlet抽象类（有协议，推荐使用）</span>
...
#### <span id="head21">2.2 Servlet的两种配置方式</span>

> Servlet的两种配置方式为web.xml配置方式和注解配置方式



##### <span id="head22">2.2.1 web.xml配置方式（支持所有版本）</span>
...
##### <span id="head23">2.2.2 注解类WebServlet配置方式（支持3.0版本以后）</span>
...
##### <span id="head24">2.2.3 IDEA中快捷创建Servlet类并自动添加注解</span>
...
##### <span id="head25">2.2.4 Servlet默认访问欢迎页面配置</span>
...
##### <span id="head26">2.2.5 Servlet访问状态码跳转页面设置</span>
...
#### <span id="head27">2.3 获取请求参数</span>
...
#### <span id="head28">2.4 处理获取请求参数乱码问题</span>



##### <span id="head29">2.4.1 表单中产生中文乱码的原因</span>

> 乱码问题，实质上就是因为服务器和客户端交互之间编码不一致造成的，所以我们解决乱码问题肯定根据实质出发，把服务器和客户端交互过程中的编码统一不就好了吗，之后就按照此编码进行数据的传输与接收。



##### <span id="head30">2.4.2 解决接收Get请求参数乱码问题</span>
...
##### <span id="head31">2.4.3 解决接收Post请求参数乱码问题</span>
...
#### <span id="head32">2.5 处理响应后浏览器显示乱码问题</span>



##### <span id="head33">2.5.1 响应后浏览器页面显示乱码的原因</span>

> 浏览器识别不到返回的中文编码格式，就会默认使用GB2312。如果返回时UTF-8编码格式，由于编码格式的不同，以至于浏览器页面就会显示乱码。



##### <span id="head34">2.5.2 解决响应后浏览器页面显示乱码问题</span>
...
### <span id="head35"> 三、Servlet与JDBC集成的综合案例</span>
...
###### <span id="head36"> db.properties配置文件</span>
...
###### <span id="head41"> UserDaoImpl实体类</span>
...
###### <span id="head42"> UserService接口</span>
...
###### <span id="head43"> UserServiceImpl实体类</span>
...
###### <span id="head44"> GetAllUserServlet</span>
...
###### <span id="head45"> InsertUserServlet</span>
...
##### <span id="head49">4.1.2 重定向的特点</span>
...
##### <span id="head50">4.1.3 利用重定向实现页面跳转</span>
...
##### <span id="head51">4.1.4 重定向的第二种方式</span>
...
#### <span id="head52">4.2 请求转发</span>

> Servlet除了支持重定向之外还支持请求转发



##### <span id="head53">4.2.1 请求转发实现原理</span>
...
##### <span id="head54">4.2.2 请求转发的特点</span>
...
##### <span id="head55">4.2.3 利用请求转发实现功能</span>
...
#### <span id="head56">4.3 response对象操作响应行和响应头</span>



##### <span id="head57">4.3.1 操作响应行</span>

###### <span id="head58">4.3.1.1 操作正常的响应状态码</span>
...
###### <span id="head59">4.3.1.2 操作错误的响应状态码</span>
...
##### <span id="head60">4.3.2 操作响应头</span>

###### <span id="head61">4.3.2.1 添加新值</span>
...
###### <span id="head62">4.3.2.2 直接赋值</span>
...
##### <span id="head63">4.4 页面的定时跳转</span>
...
#### <span id="head64">4.5 Request对象操作请求行、请求头和请求参数</span>

> **如下所有代码都遵循该注解配置：** @WebServlet(name = "RequestServletDemo", value = "/test1")



##### <span id="head65">4.5.1 操作请求行</span>

###### <span id="head66">4.5.1.1 获取请求路径</span>
...
###### <span id="head67">4.5.1.2 获取请求方式</span>
...
###### <span id="head68">4.5.1.3 获取请求地址上面的IP地址</span>
...
###### <span id="head69">4.5.1.4 获取请求地址上面的端口号</span>
...
###### <span id="head70">4.5.1.5 获取请求地址后面拼接的内容（GET请求）</span>
...
##### <span id="head71">4.5.2 操作请求头</span>

###### <span id="head72">4.5.2.1 获取User-Agent（浏览器类型）</span>
...
##### <span id="head73">4.5.3 操作请求参数【重点】</span>

###### <span id="head74">4.5.3.1 获取请求参数</span>
...
###### <span id="head75">4.5.3.2 获取所有请求参数名称</span>
...
###### <span id="head76">4.5.3.3 获取指定参数的所有值</span>
...
###### <span id="head77">4.5.3.4 获取请求参数对应的Map集合</span>
...
### <span id="head78"> 五、Servlet的生命周期</span>



#### <span id="head79">5.1 什么是生命周期？</span>
...
#### <span id="head80">5.2 Servlet生命周期的四个阶段</span>
...
##### <span id="head81">5.2.1 HttpServlet生命周期演示</span>
...
##### <span id="head85">6.2.1 加synchronized同步代码块（锁）</span>
...
##### <span id="head86">6.2.2 实现SingleThreadModle接口</span>
...
##### <span id="head87">6.2.3 使用局部变量</span>
...
### <span id="head88"> 七、Servlet初始化参数及配置</span>



#### <span id="head89">7.1 什么是Servlet初始化参数</span>

> Servlet初始化参数是Servlet调用init初始化方法同时加载的参数



#### <span id="head90">7.2 了解Servlet初始化参数机制</span>
...
#### <span id="head91">7.3 Servlet初始化参数配置方式</span>

> Servlet初始化参数配置方式有两种：**xml配置文件配置** 、**注解配置** 。



##### <span id="head92">7.3.1 xml配置文件配置初始化参数</span>
...
#### <span id="head93">7.3.2 使用注解配置初始化参数</span>
