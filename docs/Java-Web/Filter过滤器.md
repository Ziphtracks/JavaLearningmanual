- [Java Web之Filter过滤器](#head1)
	...
	- [ 四、过滤器的配置方式](#head8)
		- [4.1 xml配置](#head9)
		- [4.2 注解配置](#head10)
	- [ 五、IDEA快速创建Filter过滤器](#head11)
	- [ 六、过滤器链与优先级问题](#head12)
		- [6.1 什么是过滤器链](#head13)
		- [6.2 过滤器的优先级](#head14)
	- [ 七、过滤器的初始化参数问题](#head15)
		- [7.1 xml配置初始化参数及获取（推荐）](#head16)
		- [7.2 注解配置初始化参数及获取](#head17)
	- [ 八、通用Filter解决多个Serlvet乱码问题](#head18)
	- [ 九、自动登录综合案例](#head19)
		- [ login.html登录页面](#head20)
		- [ LoginServlet登录处理](#head21)
		- [ AutoLoginFilter实现自动登录的过滤器](#head22)
		- [ CookieUtils获取Cookies数组校验工具类](#head23)
		- [ ShowServlet展示登录结果](#head24)
	- [ 十、过滤敏感词汇案例（过滤脏话）](#head25)
		- [xml配置文件配置信息 ](#head26)
		- [ message.html发送消息的主页面](#head27)
		- [ MessageServlet服务器响应过滤后的信息](#head28)
		- [ EncodingFilter解决中文乱码问题的Filter](#head29)
		- [ 过滤脏词的Filter（动态代理增强）](#head30)
# <span id="head1">Java Web之Filter过滤器</span>

------



### <span id="head2"> 一、什么是过滤器</span>
...
### <span id="head3"> 二、了解过滤器</span>



#### <span id="head4">2.1 简单概念</span>

> 过滤器就是一个用于在请求之前处理资源的组件



#### <span id="head5">2.2 生命周期</span>
...
### <span id="head11"> 五、IDEA快速创建Filter过滤器</span>
...
### <span id="head12"> 六、过滤器链与优先级问题</span>



#### <span id="head13">6.1 什么是过滤器链</span>
...
#### <span id="head14">6.2 过滤器的优先级</span>
...
### <span id="head15"> 七、过滤器的初始化参数问题</span>



#### <span id="head16">7.1 xml配置初始化参数及获取（推荐）</span>
...
#### <span id="head17">7.2 注解配置初始化参数及获取</span>
...
### <span id="head18"> 八、通用Filter解决多个Serlvet乱码问题</span>
...
### <span id="head19"> 九、自动登录综合案例</span>
...
###### <span id="head20"> login.html登录页面</span>
...
###### <span id="head21"> LoginServlet登录处理</span>
...
###### <span id="head22"> AutoLoginFilter实现自动登录的过滤器</span>
...
###### <span id="head23"> CookieUtils获取Cookies数组校验工具类</span>
...
###### <span id="head24"> ShowServlet展示登录结果</span>
...
###### <span id="head27"> message.html发送消息的主页面</span>
...
###### <span id="head28"> MessageServlet服务器响应过滤后的信息</span>
...
###### <span id="head29"> EncodingFilter解决中文乱码问题的Filter</span>
...
###### <span id="head30"> 过滤脏词的Filter（动态代理增强）</span>
